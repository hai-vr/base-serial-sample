...
namespace ImGuiNET
{
    ...
    public class CustomImGuiController : IDisposable
    {
        ...
        public GraphicsDevice Graphics => _gd;
        ...
        /// </summary>
        public CustomImGuiController(GraphicsDevice gd, OutputDescription outputDescription, int width, int height)
        {
            _gd = gd;
            _windowWidth = width;
        ...
        {
            Assembly assembly = typeof(CustomImGuiController).Assembly;
