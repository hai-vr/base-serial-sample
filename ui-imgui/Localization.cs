...
public class Localization
{
    ...
    private const string Prefix = "pstoep_localization.";
    ...
    static Localization()
    {
        ...
        INTROSPECT_INVOKE_ALL(typeof(LocalizationPhrase.MainLocalizationPhrase));
        INTROSPECT_INVOKE_ALL(typeof(LocalizationPhrase.RoboticsLocalizationPhrase));
        PrintDatabase();
    }
    ...
    internal static string LocalizeOrElse(Type localizationGroup, string labelName, string orDefault)
    {
        var key = $"{localizationGroup.Name}__label_{labelName}";
        return DoLocalize(orDefault, key);
    }

    internal static string LocalizeOrElse__ImGuiTab(Type localizationGroup, string labelName, string orDefault)
    {
        var key = $"{localizationGroup.Name}__label_{labelName}";
    ...
    private static void INTROSPECT_INVOKE_ALL(Type type)
    {
                ...
                )
        {
            ...
            {
                if (methodInfo.Name == $"get_{nameof(LocalizationPhrase.MainLocalizationPhrase.Separator)}") separatorFound = true;
            }
        }
    }
}